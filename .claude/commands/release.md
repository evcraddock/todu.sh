...
1. **Check for unpushed commits on main**:
   ...
   - If there are any unpushed commits, **STOP** and inform the user:
     - "There are unpushed commits on the main branch. Please create a feature branch and submit a pull request before creating a release."
     - List the unpushed commits so they can see what needs to be moved
...
6. **Present findings to the user**:
   Use the AskUserQuestion tool to show:
   - Current version
